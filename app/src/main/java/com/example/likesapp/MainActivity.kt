...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        message = getString(R.string.apakah_kamu_suka_bermain)
    ...
    private fun showHair() {
        ...
        path.addCircle(halfOfWidth - 100F,halfOfHeight - 10F, 150F, android.graphics.Path.Direction.CCW)
        path.addCircle(halfOfWidth + 100F,halfOfHeight - 10F, 150F, android.graphics.Path.Direction.CCW)

        val mouth = RectF(halfOfWidth - 250F, halfOfHeight, halfOfWidth + 250F, halfOfHeight + 500F)
        path.addOval(mouth, android.graphics.Path.Direction.CCW)
